...
export function NotFound() {
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-24 text-center sm:px-6">
      ...
      <p className="mt-4 text-center text-sm font-semibold uppercase tracking-wide text-brand-blue-600">
        Erro 404
      </p>
      ...
      <p className="mt-3 text-center text-neutral-600">
        O endereço acessado não existe ou foi movido. Volte para a página inicial do PMetGIRS ou use o
        menu para encontrar o conteúdo que procura.
      </p>
      <Link
        to="/"
